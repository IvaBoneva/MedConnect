  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: "Страхотна консултация! Докторът беше търпелив и ми обясни всичко спокойно.",
      date: "05.11.2025",
    },
    {
      id: 2,
      ...
      rating: 4,
      comment: "Като цяло - добро преживяване, но може да не се намали времето за чакане.",
      date: "03.11.2025",
    },
    {
      id: 3,
      ...
      rating: 5,
      comment: "Голям професионалист, но и приятелски настроен. Силно препоръчвам!",
      date: "29.10.2025",
    },
  ];
